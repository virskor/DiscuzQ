...
import 'package:discuzq/widgets/popmenu/trianglePainter.dart';
...
class MenuItem extends MenuItemProvider {
  ...
  @override
  TextStyle get menuTextStyle =>
      textStyle ?? const TextStyle(color: const Color(0xffc5c5c5), fontSize: 10.0);
}
...
class PopupMenu {
  static var itemWidth = 60.0;
  static var itemHeight = 35.0;
  ...
  PopupMenu(
    ...
    this._backgroundColor = backgroundColor ?? const Color(0xff232323);
    this._lineColor = lineColor ?? const Color(0xff353535);
    this._highlightColor = highlightColor ?? const Color(0x55000000);
    if (context != null) {
