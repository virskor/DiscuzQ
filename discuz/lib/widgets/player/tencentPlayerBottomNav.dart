...
import 'package:discuzq/widgets/player/tencentPlayerCommonUtil.dart';
import 'package:discuzq/widgets/player/tencentPlayerLinearProgressIndicator.dart';
import 'package:discuzq/widgets/player/tencentPlayerTimeUtil.dart';
import 'package:discuzq/widgets/player/tencentPlayerTrianglePainter.dart';
import 'package:discuzq/widgets/player/tencentPlayerWidgetUtil.dart';
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        height: 6,
                        child: CustomPaint(
                          painter: TencentPlayerTrianglePainter(context),
                        ),
                      ),
                    ],
                  ),
...
class _BottomScrubberState extends State<BottomScrubber> {
  ...
  void seekToRelativePosition(Offset globalPosition) {
    double width = TencentPlayerWidgetUtil.findGlobalRect(currentKey).width;
    double xOffSet =
        TencentPlayerWidgetUtil.globalOffsetToLocal(currentKey, globalPosition)
            .dx;
    ...
    /// 回调正在交互，用来做延迟隐藏cover
    TencentPlayerCommonUtil.throttle(() {
      widget.behavingCallBack?.call();
    });
  }
    ...
    return Row(
      children: <Widget>[
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    LinearProgressIndicator(
                      ...
                      valueColor:
                          AlwaysStoppedAnimation<Color>(Color(0x33ffffff)),
        ...
        Container(
          ...
          child: Text(
            TencentPlayerTimeUtil.formatDuration(showDuration) +
                '/' +
                TencentPlayerTimeUtil.formatDuration(controller.value.duration),
            style: TextStyle(
              color: Colors.white,
              fontSize: 12,
            ),
