...
class _DiscuzEditorImageUploaderState extends State<DiscuzEditorImageUploader> {
    ...
    return ScopedStateModelDescendant<EditorState>(
        ...
        builder: (context, child, state) {
          ...
          widgets.add(GestureDetector(
            onTap: () async => await _pickImage(state: state),
  ...
  Future<void> _pickImage({@required EditorState state}) async {
  ...
  /// 进行图片上传并反馈上传结果
  ///
  Future<AttachmentsModel> _uploadImage(
      {@required EditorState state, @required File file}) async {
                  ...
                  Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () => state.removeAttachment(attachment.id),
                      ),
                    ),
                  )
                ],
