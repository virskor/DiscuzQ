...
class DiscuzContextMenuAction extends StatefulWidget {
  /// Construct a DiscuzContextMenuAction.
  const DiscuzContextMenuAction({
    Key key,
    @required this.child,
  ...
  @override
  _DiscuzContextMenuActionState createState() =>
      _DiscuzContextMenuActionState();
}

class _DiscuzContextMenuActionState
    extends State<DiscuzContextMenuAction> {
